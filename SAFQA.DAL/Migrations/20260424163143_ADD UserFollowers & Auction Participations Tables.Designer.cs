...
namespace SAFQA.DAL.Migrations
{
    ...
    [Migration("20260424163143_ADD UserFollowers & Auction Participations Tables")]
    partial class ADDUserFollowersAuctionParticipationsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SAFQA.DAL.Models.AuctionParticipations", b =>
                {
                    ...
                    b.ToTable("BidParticipations", (string)null);
                });
            ...
            modelBuilder.Entity("SAFQA.DAL.Models.AuctionView", b =>
                {
                    ...
                    b.ToTable("AuctionViews", (string)null);
                });
            ...
            modelBuilder.Entity("SAFQA.DAL.Models.OrderTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SAFQA.DAL.Models.OrderTracking", b =>
                {
                    b.HasOne("SAFQA.DAL.Models.Auction", "Auction")
                        ...
                        .HasForeignKey("SAFQA.DAL.Models.OrderTracking", "AuctionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
